# Contributing to NuGet Cache Tool

Thank you for your interest in contributing to NuGet Cache Tool! We welcome contributions from the community and appreciate
...
- **Environment**: Operating system, .NET version, NuGet Cache Tool version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/NuGetCacheTool.git
   cd NuGetCacheTool
   ```
...
NuGet Cache Tool uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to NuGet Cache Tool, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to NuGet Cache Tool!

[code-of-conduct]: https://github.com/demaconsulting/NuGetCacheTool/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/NuGetCacheTool/discussions
[issues]: https://github.com/demaconsulting/NuGetCacheTool/issues
[security]: https://github.com/demaconsulting/NuGetCacheTool/blob/main/SECURITY.md
