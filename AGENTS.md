...
- **project-name**: NuGet Cache Tool
- **organization**: DEMA Consulting
- **description**: A .NET global tool that ensures NuGet packages are cached in the global packages folder
- **languages**: C#
- **technologies**: .NET 8/9/10, NuGet, xUnit
